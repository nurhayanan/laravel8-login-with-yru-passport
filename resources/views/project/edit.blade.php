...
@section('content')
    ...
    <div _ngcontent-irs-c70="" class="content-title content-title-clear ng-star-inserted">
        <h4 _ngcontent-irs-c70="">วิจัย - รายละเอียดโครงการ</h4>
    </div>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form name="save-multiple-files" action="{{ route('project.update',$project->id) }}" method="POST"
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td> <textarea class="form-control" style="height:50px" name="project_name"
                                                placeholder="Enter Description">{{ $project->project_name }}</textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td> <textarea class="form-control" style="height:50px" name="name_eng"
                                                placeholder="Enter Description">{{ $project->name_eng }}</textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td> <input class="form-control" style="height:50px" name="budget"
                                                placeholder="Enter Description" value="{{ $project->budget }}">
                                        </td>
                                    </tr>
                                    ...
                                    <div class="panel panel-footer">
                                        <table class="table table-bordered" id="crud_table">
                                            ...
                                            @if (old('row') != '')
                                                            ...
                                                            <td>
                                                                <div
                                                                    ...
                                                                    <input type="text"
                                                                        ...
                                                                        class="form-control associate" id="associate"
                                                ...
                                                @else
                                                @if($projectsub != '')
                                                    <?php $rowReplace = count($projectsub); ?>
                                                        <tbody class="original-tbody-destination" id="original-tbody-destination">
                                                            @foreach($projectsub as $key => $projectsubs)
                                                                <tr class="table_field main_data " id="table_field">
                                                                    <td>
                                                                        <input type="text" name="row[{{$projectsubs->id}}][associate]" class="form-control associate" id="associate" value="{{ $projectsubs->associate }}">
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" name="row[{{$projectsubs->id}}][percent]" class="form-control percent"  maxlength="3" id="percent" value="{{ $projectsubs->percent }}">
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" name="row[{{$projectsubs->id}}][position]" class="form-control position"  maxlength="3" id="position" value="{{ $projectsubs->position }}">
                                                                    </td>
                                    ...
                                    <div class="form-group">
                                        {{-- {!! Form::label('ไฟล์ propesol') !!}<span style="color: red;">*</span>
                                        {!! Form::file('file_path',null, ["class"=>"form-control"]) !!}({{ $project->name }}) --}}
                                        <label for="link">ไฟล์ propesol: ({{ $project->name }})</label><span style="color: red;">*</span>
    ...
    <script type="text/javascript">
        ...
        function addRow() {
            var tr = '<tr class="table_field main_data " id="table_field-' + (int) + '">' +
                ...
                '][associate]" class="form-control associate" id="associate"></td>' +
                '<td><input type="text" name="row[' + (int) +
