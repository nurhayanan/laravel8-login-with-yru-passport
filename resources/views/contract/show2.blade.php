    ...
    <div class="col-md-12">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"> วิจัย - รายละเอียดสัญญารับทุนวิจัย
                </li>
            </ol>
        </nav>
    </div>
  ...
  <br><br>
      ...
      @endphp --}}
        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">{{$data->project_name}}</div>
                    <div class="card-body">
                        @if ($errors->all())
                    ...
                    <div class="card-body">
                         <div class="col-md-12">
                            <table class="table table-hover">
                                ...
                                @foreach ($project as $projects)   @endforeach
                                <tbody>
                                    <tr>
                                        <td width="30%">แหล่งทุน</td>
                                        <td>{{ $projects->funding_name }}</td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{-- <a href="/../generate-pdf">22375_เอกสารสัญญาค้ำ</a><br>
                                        <a href="/../generate-pdf1">22376_เอกสารสัญญารับทุน</a> --}}
