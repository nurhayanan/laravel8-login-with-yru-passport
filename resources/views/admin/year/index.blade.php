                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">ข้อมูลปีงบประมาณ</h3>
                            <h6 class="text-danger">
                                <a href="{{ route('year.create') }}" class="btn btn-outline-primary "
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('year.destroy',$value->id) }}" method="POST">
                                                @csrf @method('DELETE')
                                                <a href="{{ route('year.edit',$value->id) }}" class="btn btn-sm btn-success"><span
